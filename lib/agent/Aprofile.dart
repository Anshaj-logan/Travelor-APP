...
class _AprofileState extends State<Aprofile> {
  ...
  _fetchData() async {
    ...
    var res = await Api().getData(
        '/api/agent/view_agent_profile/' + login_id.replaceAll('"', ''));
    print(res);
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                  onPressed: () => Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => const Ahome())),
                ...
                IconButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Aedit(_id, login_id)));
                    },
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    _loaduserdata[position]["address"],
                                    style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                                    ),
