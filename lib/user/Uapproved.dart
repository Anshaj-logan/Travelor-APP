...
class Uapproved extends StatefulWidget {
  const Uapproved({Key? key}) : super(key: key);

  @override
  State<Uapproved> createState() => _UapprovedState();
}

class _UapprovedState extends State<Uapproved> {
        ...
        appBar: AppBar(backgroundColor:Color(0xff00ADB5),
          ...
          leading: IconButton(
              onPressed: () => Navigator.pop(context),
                  //Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const Umsg())),
